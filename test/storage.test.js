...
function buildEngine(filename) {
    switch (engineName) {
        ...
        case 'mongo':
            return new engine_1.EngineMongo();
        case 'postgres':
...
describe('storage', function () {
    ...
    describe('ChannelsDatabase', function () {
        ...
        describe('#saveOrUpdate', function () {
            it('save new PaymentChannel', function () {
                channels.contract.getState.resolves(0);
                var channelId = support.randomChannelId();
                var hexChannelId = channelId.toString();
                var paymentChannel = new payment_channel_1.PaymentChannel('sender', 'receiver', hexChannelId, new BigNumber.BigNumber(10), new BigNumber.BigNumber(0), 0, undefined);
                return channels.firstById(channelId).then(function (found) {
    ...
    describe('#allOpen', function () {
        it('returns all open channels', function () {
            ...
            var paymentChannel4 = new payment_channel_1.PaymentChannel('sender', 'receiver', hexChannelId4, new BigNumber.BigNumber(10), new BigNumber.BigNumber(0), 0, undefined);
        ...
        describe('#findUsable', function () {
            it('returns the first channel for the specified sender and receiver whose value is less than the sum of the channel value and amount', function () {
                ...
                return Promise.all([
                    channels.save(new payment_channel_1.PaymentChannel('sender', 'receiver', support.randomChannelId().toString(), new BigNumber.BigNumber(9), new BigNumber.BigNumber(8), 0, undefined)),
                    channels.save(new payment_channel_1.PaymentChannel('sender', 'receiver', correct, new BigNumber.BigNumber(13), new BigNumber.BigNumber(0), 0, undefined)),
                    channels.save(new payment_channel_1.PaymentChannel('sender', 'receiver', remotelyModifiedId, new BigNumber.BigNumber(13), new BigNumber.BigNumber(0), 0, undefined)),
                    channels.save(new payment_channel_1.PaymentChannel('sender', 'receiver', support.randomChannelId().toString(), new BigNumber.BigNumber(13), new BigNumber.BigNumber(0), 2, undefined)),
                    channels.save(new payment_channel_1.PaymentChannel('sender', 'receiver', support.randomChannelId().toString(), new BigNumber.BigNumber(130), new BigNumber.BigNumber(0), 1, undefined)),
                    channels.save(new payment_channel_1.PaymentChannel('othersender', 'receiver', support.randomChannelId().toString(), new BigNumber.BigNumber(11), new BigNumber.BigNumber(0), 0, undefined)),
                    channels.save(new payment_channel_1.PaymentChannel('othersender', 'receiver', support.randomChannelId().toString(), new BigNumber.BigNumber(11), new BigNumber.BigNumber(0), 2, undefined))
