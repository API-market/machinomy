...
var PaymentManager = /** @class */ (function () {
    function PaymentManager(chainManager, channelContract) {
    ...
    PaymentManager.prototype.isValid = function (payment, paymentChannel) {
        return __awaiter(this, void 0, void 0, function () {
            var validIncrement, validChannelValue, validChannelId, validPaymentValue, validSender, isPositive, canClaim;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
