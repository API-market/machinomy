...
function defaultRegistry() {
    ...
    serviceRegistry.bind('ChannelManager', function (account, web3, channelsDao, paymentsDao, tokensDao, channelContract, paymentManager) { return new channel_manager_1.ChannelManagerImpl(account, web3, channelsDao, paymentsDao, tokensDao, channelContract, paymentManager); }, ['account', 'Web3', 'ChannelsDatabase', 'PaymentsDatabase', 'TokensDatabase', 'ChannelContract', 'PaymentManager']);
    ...
    serviceRegistry.bind('Engine', function (options) {
        ...
        switch (options.engine) {
            case 'nedb':
                return new engine_1.EngineNedb(options.databaseFile, false);
            case 'mongo':
    ...
    serviceRegistry.bind('PaymentManager', function (chainManager, channelContract) { return new payment_manager_1["default"](chainManager, channelContract); }, ['ChainManager', 'ChannelContract']);
