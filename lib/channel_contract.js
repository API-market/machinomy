...
var ChannelContract = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deployed = _a.sent();
                        return [2 /*return*/, deployed.open(ChannelContract.generateId(), receiver, settlementPeriod, {
                                from: sender,
                                value: price,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        deployed = _a.sent();
                        return [2 /*return*/, deployed.deposit(channelId, {
                                from: sender,
                                value: value,
                                gas: CREATE_CHANNEL_GAS
                            })];
    ...
    ChannelContract.prototype.contract = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!!this._contract) return [3 /*break*/, 5];
                        _a = this;
                    ...
                    case 1:
                        _b = _c.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, contracts_1.Unidirectional.contract(this.web3.currentProvider).deployed()];
                    case 3:
                        _b = _c.sent();
                        _c.label = 4;
                    case 4:
                        ...
                        _c.label = 5;
                    case 5: return [2 /*return*/, this._contract];
                }
            });
        });
    };
